      ...
      <form class="login-form">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="email" type="text" ng-model="cnh">
            <label for="username" class="center-align">cnh</label>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
  ...
  <script type="text/javascript" src="/js/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      $scope.logar_app = function() {
        $.post('/airportzoom/driver/logar',{'cnh':$scope.cnh,'password':$scope.password},function(data){
          if(data.status==1){
            localStorage.setItem("nome", data.nome);
            localStorage.setItem("cnh", $scope.cnh);
